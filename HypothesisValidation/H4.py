...
def H4(path):
    ...
    sql_query = "SELECT survey_response.course_user_id, survey_response.answer FROM survey_response, global_user WHERE survey_response.course_user_id=global_user.course_user_id AND global_user.course_id=\"DelftX/FP101x/3T2014\" AND survey_response.question_id=\"DelftX/FP101x/3T2014_pre_Q4.1\""
    cursor.execute(sql_query)
    results = cursor.fetchall()
    ...
    sql_query = "SELECT survey_response.course_user_id, survey_response.answer FROM survey_response, global_user WHERE survey_response.course_user_id=global_user.course_user_id AND global_user.course_id=\"DelftX/FP101x/3T2014\" AND survey_response.question_id=\"DelftX/FP101x/3T2014_pre_Q6.3\""
    cursor.execute(sql_query)
    results = cursor.fetchall()
    ...
    sql_query = "SELECT survey_response.course_user_id, survey_response.answer FROM survey_response, global_user WHERE survey_response.course_user_id=global_user.course_user_id AND global_user.course_id=\"DelftX/FP101x/3T2014\" AND survey_response.question_id=\"DelftX/FP101x/3T2014_pre_Q6.4\""
    cursor.execute(sql_query)
    results = cursor.fetchall()
