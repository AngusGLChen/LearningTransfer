...
def H5(path):
    ...
    question_ids = ["Q2.3_4", "Q2.3_5", "Q2.3_7", "Q2.3_8", "Q2.3_9", "Q2.3_10", "Q2.3_15"]
    question_ids = ["Q2.3_4", "Q2.3_5", "Q2.3_7", "Q2.3_8", "Q2.3_9", "Q2.3_10", "Q2.3_15", "Q2.4_4", "Q2.4_5", "Q2.4_6", "Q2.4_7", "Q2.4_8", "Q2.4_9", "Q2.4_10"]
    ...
    for id in question_ids:        
        ...
        for result in results:
            ...
            if answer in ["1","2"]:
                if course_user_id not in low_learners:
