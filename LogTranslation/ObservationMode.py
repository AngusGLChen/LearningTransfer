...
def observation_mode(path):
    ...
    for file in files:             
        if "course_structure" in file:            
            ...
            resources_path = os.path.dirname(os.path.dirname(os.path.dirname(path))) + "/Results/FP101x/" + "resources.csv"
    ...
    sessions_path = os.path.dirname(os.path.dirname(os.path.dirname(path))) + "/Results/FP101x/" + "sessions.csv"
    ...
    user_all_event_logs = {}
    # compressed_event_logs = {}
    sessions = {}
    
    # updated_user_all_event_logs = {}
    ...
    observations_path = os.path.dirname(os.path.dirname(os.path.dirname(path))) + "/Results/FP101x/" + "observations.csv"
