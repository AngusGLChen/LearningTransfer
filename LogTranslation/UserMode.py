...
def user_mode(path):
    ...
    for file in files:             
        if "course_structure" in file:           
            ...
            # Output course table
            course_table_path = os.path.dirname(os.path.dirname(os.path.dirname(path))) + "/Results/FP101x/" + "courses.csv"            
    ...
    for file in files:       
        if "student_courseenrollment" in file:
            ...
            global_user_path = os.path.dirname(os.path.dirname(os.path.dirname(path))) + "/Results/FP101x/" + "global_user.csv"
    ...
    for file in files:       
        if "certificates_generatedcertificate" in file:
            ...
            course_user_path = os.path.dirname(os.path.dirname(os.path.dirname(path))) + "/Results/FP101x/" + "course_user.csv"
