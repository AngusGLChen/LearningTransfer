...
def submission_mode(path):
    ...
    for file in files:   
        if "course_structure" in file:                       
            ...
            problems_path = os.path.dirname(os.path.dirname(os.path.dirname(path))) + "/Results/FP101x/" + "problems.csv"
    ...
    submissions_path = os.path.dirname(os.path.dirname(os.path.dirname(path))) + "/Results/FP101x/" + "submissions.csv"
    ...
    assessments_path = os.path.dirname(os.path.dirname(os.path.dirname(path))) + "/Results/FP101x/" + "assessments.csv"
                    ...
                    if jsonObject["event_type"] in submission_event_collection:
                        ...
                        if jsonObject["context"]["user_id"] != "":
                            ...
                            if isinstance(jsonObject["event"], dict):                     
                                ...
                                # The files "grade" and "max_grade" are specific to submission event "problem_check"
